...
# move kernel tasks into housekeeping
cset proc --kthread --fromset=root --toset=housekeeping --force

# init-process must be in root cg 
cset proc --toset=root --move --pid 1
