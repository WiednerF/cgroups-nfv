...
\begin{document}
    \begin{tikzpicture}[>=latex]
        ...
        \begin{axis}[
            ...
            % runlatencies-pre-rate800000-repeat0.pcap.zst.trim_ms0.num_worst5000.worst.csv
            % loop Not Known
            \addplot table[
                col sep=comma,
                scatter,
            ...
            ]{results/latencies-pre-rate800000-repeat0.pcap.zst.trim_ms0.num_worst5000.worst.csv};
