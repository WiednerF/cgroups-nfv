...
\begin{document}
    \begin{tikzpicture}[>=latex]
        ...
        \begin{axis}[
            ...
            % runlatencies-pre-rate700000-repeat0.pcap.zst.bucket_size100.trim_ms0.jitterpre.csv
            % loop Not Known
            \addplot table[
                col sep=comma,
                x expr= \thisrowno{0}/1000,
                y expr= \thisrowno{1},
            ]{results/latencies-pre-rate700000-repeat0.pcap.zst.bucket_size100.trim_ms0.jitterpre.csv};
